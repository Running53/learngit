        ...
        ajax({
            ...
            success: function(results) {
                ...
                for(var i=results.listsongs.length-1;i >= 0;i--) { 
                    str = '<li><a href="javascript:;">'+results.listsongs[i].song+'</a><a href="javascript:;">'+results.listsongs[i].singer+'</a><a href="javascript" title="播放"></a><span title="收藏单曲"></span><span title="删除"></span></li>';
                    src = str + src;
                    if(i == 0) {
